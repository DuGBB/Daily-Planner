...
function timeContainer() {//time-block display function
    currentDay();
    var oldTimeContainer = document.getElementById("timeBox");
    var timeContainer = document.createElement("div");
    timeContainer.setAttribute("id","timeBox");
    timeContainer.setAttribute("class", "container");
var createTable = document.createElement("table");
    ...
    oldTimeContainer.parentElement.replaceChild(timeContainer, oldTimeContainer);
}
